...
Option Settings Key (in JSON):
  _settings: Contains global settings for the text edit tool
    - no_selection_placeholder: Placeholder text when no text is selected
    - selection_placeholder: Placeholder text when text is selected
...
Per-Action Options:
  ...
  - action_show_in_chat_window: Whether to show result in chat window (default: false)
...
DEFAULT_SETTINGS = {
    "no_selection_placeholder": "Ask your AI...",
    "selection_placeholder": "Describe your change...",
...
DEFAULT_OPTIONS = {
    "Proofread": {
        ...
        "action_show_in_chat_window": False
    },
    "Rewrite": {
        "prefix": "Rewrite this:\n\n",
    ...
    "Summary": {
        ...
        "action_show_in_chat_window": True
    },
    "Key Points": {
